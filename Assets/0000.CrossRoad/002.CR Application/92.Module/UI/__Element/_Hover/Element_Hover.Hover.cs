...
namespace Module.UI
{
    ...
    public partial class Element_Hover : AElement
    {
		public void HoverPanel_OnHover(APacket _value)
		{
			...
			// 4. 호버 패널
			GameObject hPanel = m_data.m_hoverPanel;
			...
			// 5. 호버 텍스트
			TextMeshProUGUI title =  m_data.m_title;
			TextMeshProUGUI hText1 = m_data.m_hoverText1;
			TextMeshProUGUI hText2 = m_data.m_hoverText2;
			TextMeshProUGUI hText3 = m_data.m_hoverText3;
			TextMeshProUGUI hText4 = m_data.m_hoverText4;
			TextMeshProUGUI hText5 = m_data.m_hoverText5;
		...
		{
			m_data.m_hoverPanel.SetActive(false);
		}
