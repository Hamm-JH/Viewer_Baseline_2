...
namespace AdminViewer.API
{
	public class Capture : MonoBehaviour
	{
		...
		public IEnumerator GetImage(Module_WebAPI callback, List<GameObject> toggles = null)
		//public IEnumerator GetImage(Manager.UIManager callback, List<GameObject> toggles = null)
		{
			...
			if (env.isFirst)
			{
				callback.capture.L1_Result = base64Image;
				callback.capture.isCapEnd1 = true;
			}
			else if (env.isSecond)
			{
				callback.capture.L2_Result = base64Image;
				callback.capture.isCapEnd2 = true;
			}
			else if (env.isThird)
			{
				callback.capture.L3_Result = base64Image;
				callback.capture.isCapEnd3 = true;
			}
